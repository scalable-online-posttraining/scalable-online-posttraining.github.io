...
Production: https://tauteamhq.github.io/sop/
...
Run `python3 scripts/check_site.py` before publishing. Push a verified change to `main`; the **Deploy SOP** GitHub Actions workflow validates and publishes `public/` to GitHub Pages. Media assets must stay below 90 MiB per file and the published directory below 800 MiB. Keep URLs relative so `/sop/` works correctly.
